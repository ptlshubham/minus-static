    ...
    <div class="col-full">
        ...
        <div class="footer-payment-icons">
            <ul class="list-payment-icons">
                ...
                </li><li><i class="fa fa-cc-visa"></i></li>
                <li><i class="fa fa-cc-mastercard"></i></li>
            </ul>
        </div>
        <div class="pizzaro-handheld-footer-bar">
            <ul class="columns-3">
                <li class="my-account"><a href="index.php?page=login-and-register">My Account</a></li>
                ...
                <li class="cart"><a class="footer-cart-contents" href="index.php?page=cart" title="View your shopping cart"><span class="count">2</span></a></li>
            </ul>
        </div>
