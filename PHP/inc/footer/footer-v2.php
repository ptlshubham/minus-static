<?php require_once 'inc/footer/footer-about-info.php'; ?>
<?php require_once 'inc/footer/footer-map.php'; ?>
    ...
    <div class="col-full">
        ...
        <div class="pizzaro-handheld-footer-bar">
            <ul class="columns-3">
                ...
                <li class="cart">
                    <a class="footer-cart-contents" href="index.php?page=cart" title="View your shopping cart"><span class="count">2</span></a>
                </li>
            </ul>
        </div>
