			...
			<form name="checkout"  class="checkout woocommerce-checkout" action="#" enctype="multipart/form-data">
				...
				<div id="order_review" class="woocommerce-checkout-review-order">
					<table class="shop_table woocommerce-checkout-review-order-table">
						...
						<tbody>
							<tr class="cart_item">
								<td class="product-name">Bacon Burger&nbsp;<strong class="product-quantity">&times; 1</strong>
									<dl class="variation">
							...
							<tr class="cart_item">
								<td class="product-name">Pepperoni Pizza&nbsp;<strong class="product-quantity">&times; 1</strong>
									<dl class="variation">
										<dt class="variation-Baseprice">Base price:</dt>
										<dd class="variation-Baseprice">
											<p><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#036;</span>0.00</span></p>
					...
					<div id="payment" class="woocommerce-checkout-payment">
						...
						<div class="form-row place-order">
							...
							<p class="form-row terms wc-terms-and-conditions">
								...
								<label for="terms" class="checkbox">I&rsquo;ve read and accept the <a href="index.php?page=terms-and-conditions" target="_blank">terms &amp; conditions</a> <span class="required">*</span></label>
								<input type="hidden" name="terms-field" value="1" />
							</p>

							<a class="button alt" href="index.php?page=order-received" style="text-align: center;">Place order</a>
						</div>
					</div>
				</div>
