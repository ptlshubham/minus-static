		...
		<div id="primary" class="content-area">
			<main id="main" class="site-main" >
				...
				<div class="product type-product status-publish has-post-thumbnail product_cat-pizza pa_food-type-veg first instock shipping-taxable purchasable product-type-variable has-children">
					...
					<?php require_once 'inc/blocks/single-product/single-product-v2.php'; ?>
					<?php require_once 'inc/blocks/single-product/product-form-wrapper-v1.php'; ?>
					<?php require_once 'inc/blocks/single-product/pizzaro-taps.php'; ?>
