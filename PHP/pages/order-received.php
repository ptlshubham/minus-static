                                ...
                                <tbody>
                                    <tr class="order_item">
                                        <td class="product-name">
                                            <a href="index.php?page=single-product-v1">Country Burger</a> <strong class="product-quantity">× 1</strong><dl class="variation">
                                                ...
                                                <dd class="variation-PickSize362590"><p>29  cm</p></dd>
                                            </dl>
                                        </td>
